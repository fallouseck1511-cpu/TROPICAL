...
LANDING_HTML = '<!DOCTYPE html>\n<html lang="fr">\n<head>\n<meta charset="UTF-8">\n<meta name="viewport" content="width=device-width,initial-scale=1">\n<title>LE TROPICAL — Centre de santé, Thiès</title>\n<link rel="preconnect" href="https://fonts.googleapis.com">\n<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\n<link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700;9..144,800&family=IBM+Plex+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">\n<style>\n:root{\n  --ink:#1C2420; --canopy:#0F4D3A; --canopy-deep:#0A3627; --canopy-tint:#DCEBE3;\n  --clay:#B9532C; --clay-deep:#96421F;\n  --gold:#D9A441; --gold-tint:#FBEBD8;\n  --sand:#F1E9D8; --sand-deep:#E4DAC0; --card:#FFFFFF; --line:#E4DCC8; --muted:#6B7A70;\n  --r-sm:6px;--r-md:10px;--r-lg:18px;--r-xl:26px;\n  --shadow:0 20px 48px -18px rgba(15,30,22,.28);\n}\n*{box-sizing:border-box;}\nhtml{scroll-behavior:smooth;}\nhtml,body{margin:0;padding:0;}\nbody{background:var(--sand);color:var(--ink);font-family:\'IBM Plex Sans\',system-ui,sans-serif;-webkit-font-smoothing:antialiased;}\nh1,h2,h3{font-family:\'Fraunces\',serif;letter-spacing:-.01em;margin:0;}\n.wrap{max-width:1180px;margin:0 auto;padding:0 28px;}\n@media (max-width:700px){.wrap{padding:0 20px;}}\n\n/* nav */\n.nav{position:sticky;top:0;z-index:40;background:rgba(241,233,216,.9);backdrop-filter:blur(8px);border-bottom:1px solid var(--line);}\n.nav-in{display:flex;align-items:center;justify-content:space-between;padding:14px 28px;max-width:1180px;margin:0 auto;}\n.nav-brand{display:flex;align-items:center;gap:9px;font-family:\'Fraunces\';font-weight:700;font-size:1.05rem;color:var(--canopy-deep);}\n.nav-brand .crest{width:30px;height:30px;border-radius:8px;background:var(--canopy);display:flex;align-items:center;justify-content:center;}\n.nav-brand .crest svg{width:15px;height:15px;}\n.nav-links{display:flex;gap:26px;font-size:.86rem;font-weight:600;color:var(--muted);}\n.nav-links a{text-decoration:none;color:inherit;}\n.nav-links a:hover{color:var(--canopy);}\n@media (max-width:780px){.nav-links{display:none;}}\n.btn{border:none;border-radius:999px;padding:10px 20px;font-size:.84rem;font-weight:700;cursor:pointer;font-family:\'IBM Plex Sans\';display:inline-flex;align-items:center;gap:7px;transition:.15s;}\n.btn svg{width:14px;height:14px;}\n.btn-clay{background:var(--clay);color:#fff;}\n.btn-clay:hover{background:var(--clay-deep);}\n.btn-ghost{background:transparent;color:var(--canopy-deep);border:1.5px solid var(--line);}\n.btn-ghost:hover{border-color:var(--canopy);}\n\n.a-eyebrow{display:inline-flex;align-items:center;gap:7px;background:var(--canopy-tint);color:var(--canopy-deep);font-size:.76rem;font-weight:700;padding:6px 13px;border-radius:999px;margin-bottom:18px;}\n\n/* ===== HERO : texte institutionnel + panneau produit ===== */\n.hero{padding:60px 0 30px;}\n.hero-in{display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center;}\n@media (max-width:960px){.hero-in{grid-template-columns:1fr;}}\n.hero h1{font-size:2.5rem;line-height:1.1;margin-bottom:16px;}\n@media (max-width:600px){.hero h1{font-size:1.9rem;}}\n.hero p.lead{font-size:1.02rem;color:var(--muted);max-width:46ch;line-height:1.6;margin-bottom:26px;}\n.ctas{display:flex;gap:12px;flex-wrap:wrap;}\n.trustrow{display:flex;gap:30px;margin-top:34px;flex-wrap:wrap;}\n.trustrow .ti .n{font-family:\'Fraunces\';font-size:1.5rem;font-weight:700;color:var(--canopy-deep);}\n.trustrow .ti .l{font-size:.72rem;color:var(--muted);}\n\n/* product mock (from style B) */\n.mock-wrap{position:relative;}\n.b-float{position:absolute;background:var(--card);border:1px solid var(--line);border-radius:var(--r-md);padding:10px 14px;box-shadow:var(--shadow);font-size:.76rem;font-weight:700;display:flex;align-items:center;gap:8px;z-index:2;}\n.b-float.f1{top:-16px;right:8%;color:var(--clay);}\n.b-float.f2{bottom:10%;left:-16px;color:var(--canopy);}\n@media (max-width:760px){.b-float{display:none;}}\n.b-dot{width:7px;height:7px;border-radius:50%;background:currentColor;}\n.b-dot.pulse{animation:pulseB 1.4s infinite;}\n@keyframes pulseB{50%{opacity:.25;}}\n.b-mock{background:var(--card);border:1px solid var(--line);border-radius:var(--r-xl);box-shadow:0 40px 80px -30px rgba(15,30,22,.35);overflow:hidden;transform:perspective(1400px) rotateY(-4deg) rotateX(2deg);}\n.b-mock-top{background:var(--sand-deep);padding:10px 16px;display:flex;gap:6px;}\n.b-mock-top span{width:9px;height:9px;border-radius:50%;background:#D8CBA8;}\n.b-mock-body{padding:22px 24px;}\n.b-mrow{display:flex;gap:12px;margin-bottom:16px;flex-wrap:wrap;}\n.b-stat{flex:1;min-width:110px;background:var(--sand);border:1px solid var(--line);border-radius:var(--r-md);padding:13px 15px;position:relative;overflow:hidden;}\n.b-stat::before{content:"";position:absolute;left:0;top:0;bottom:0;width:3px;}\n.b-stat.c1::before{background:var(--canopy);}\n.b-stat.c2::before{background:var(--clay);}\n.b-stat.c3::before{background:var(--gold);}\n.b-stat .v{font-family:\'Fraunces\';font-weight:700;font-size:1.2rem;}\n.b-stat .l{font-size:.66rem;color:var(--muted);text-transform:uppercase;letter-spacing:.03em;}\n.b-listrow{display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--line);}\n.b-listrow:last-child{border:none;}\n.b-av{width:28px;height:28px;border-radius:50%;background:var(--canopy-tint);color:var(--canopy);font-family:\'Fraunces\';font-weight:700;font-size:.7rem;display:flex;align-items:center;justify-content:center;flex:none;}\n.b-listrow .who{flex:1;font-size:.8rem;font-weight:600;}\n.b-listrow .who span{display:block;font-size:.7rem;color:var(--muted);font-weight:400;}\n.b-tag{font-size:.65rem;font-weight:700;padding:3px 9px;border-radius:999px;background:var(--canopy-tint);color:var(--canopy);white-space:nowrap;}\n\n.section{padding:60px 0;}\n.section-hdr{text-align:center;max-width:580px;margin:0 auto 40px;}\n.section-hdr h2{font-size:1.8rem;}\n.section-hdr p{color:var(--muted);font-size:.92rem;margin-top:10px;}\n\n/* bento features */\n.bento{display:grid;grid-template-columns:repeat(4,1fr);gap:18px;}\n@media (max-width:900px){.bento{grid-template-columns:repeat(2,1fr);}}\n@media (max-width:520px){.bento{grid-template-columns:1fr;}}\n.bento .card{background:var(--card);border:1px solid var(--line);border-radius:var(--r-lg);padding:22px;transition:.15s;}\n.bento .card:hover{transform:translateY(-3px);box-shadow:var(--shadow);}\n.bento .card.big{grid-column:span 2;}\n@media (max-width:520px){.bento .card.big{grid-column:span 1;}}\n.bento .ic{width:38px;height:38px;border-radius:10px;display:flex;align-items:center;justify-content:center;margin-bottom:14px;}\n.bento .ic svg{width:18px;height:18px;color:#fff;}\n.bento h4{font-size:.94rem;margin-bottom:6px;}\n.bento p{font-size:.82rem;color:var(--muted);margin:0;line-height:1.55;}\n\n/* values (human) */\n.values{display:grid;grid-template-columns:repeat(3,1fr);gap:24px;}\n@media (max-width:780px){.values{grid-template-columns:1fr;}}\n.val{text-align:center;padding:8px;}\n.val .ic{width:58px;height:58px;border-radius:50%;background:#fff;border:2px solid var(--gold-tint);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;}\n.val .ic svg{width:24px;height:24px;color:var(--clay);}\n.val h4{font-size:1rem;margin-bottom:8px;}\n.val p{font-size:.85rem;color:var(--muted);max-width:28ch;margin:0 auto;line-height:1.6;}\n\n/* stats band */\n.stats{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;text-align:center;background:var(--canopy-deep);border-radius:var(--r-xl);padding:44px 30px;color:#fff;}\n@media (max-width:700px){.stats{grid-template-columns:repeat(2,1fr);}}\n.stats .n{font-family:\'Fraunces\';font-size:2.1rem;font-weight:700;}\n.stats .l{font-size:.76rem;opacity:.72;margin-top:4px;}\n\n/* testimonial carousel */\n.carousel{max-width:640px;margin:0 auto;text-align:center;position:relative;min-height:150px;}\n.slide{display:none;}\n.slide.active{display:block;}\n.slide p{font-family:\'Fraunces\';font-style:italic;font-size:1.2rem;line-height:1.6;color:var(--canopy-deep);}\n.slide .who{margin-top:16px;font-size:.83rem;font-weight:700;color:var(--muted);}\n.dots{display:flex;justify-content:center;gap:7px;margin-top:22px;}\n.dots button{width:8px;height:8px;border-radius:50%;border:none;background:var(--gold-tint);cursor:pointer;}\n.dots button.active{background:var(--clay);}\n\n.final-cta{background:var(--clay);border-radius:var(--r-xl);padding:48px 40px;text-align:center;color:#fff;}\n.final-cta h2{font-size:1.7rem;margin-bottom:12px;color:#fff;}\n.final-cta p{opacity:.9;margin-bottom:22px;}\n.final-cta .btn-ghost{background:#fff;color:var(--clay-deep);border:none;}\n\n.foot{background:var(--canopy-deep);color:rgba(255,255,255,.7);padding:44px 0 26px;margin-top:80px;}\n.foot .wrap{display:flex;justify-content:space-between;flex-wrap:wrap;gap:24px;}\n.foot .col h4{color:#fff;font-family:\'Fraunces\';font-size:.95rem;margin-bottom:10px;}\n.foot .col div{font-size:.82rem;line-height:1.9;}\n.foot .bottom{border-top:1px solid rgba(255,255,255,.15);margin-top:28px;padding-top:18px;font-size:.74rem;text-align:center;color:rgba(255,255,255,.5);}\n</style>\n</head>\n<body>\n\n<nav class="nav">\n  <div class="nav-in">\n    <div class="nav-brand"><div class="crest"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8"><path d="M12 21s-7-4.4-9.5-9C.7 8.2 2.6 4 6.5 4c2 0 3.4 1 5.5 3 2.1-2 3.5-3 5.5-3 3.9 0 5.8 4.2 4 8-2.5 4.6-9.5 9-9.5 9z"/></svg></div>LE TROPICAL</div>\n    <div class="nav-links"><a href="#fonctionnalites">Fonctionnalités</a><a href="#valeurs">Nos valeurs</a><a href="#temoignages">Témoignages</a></div>\n    <button class="btn btn-clay" onclick="location.href=\'/login\'">Se connecter</button>\n  </div>\n</nav>\n\n<!-- HERO -->\n<div class="hero wrap">\n  <div class="hero-in">\n    <div>\n      <span class="a-eyebrow"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Centre de santé agréé — Thiès</span>\n      <h1>Des soins attentifs, un outil moderne pour les porter.</h1>\n      <p class="lead">LE TROPICAL accompagne les familles de Thiès avec des consultations, un suivi médical continu et des téléconsultations — soutenu par un système de gestion pensé pour notre équipe.</p>\n      <div class="ctas">\n        <button class="btn btn-clay" onclick="location.href=\'/login\'">Prendre rendez-vous<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg></button>\n        <button class="btn btn-ghost" onclick="location.href=\'/login\'">Se connecter à mon espace</button>\n      </div>\n      <div class="trustrow">\n        <div class="ti"><div class="n">12k+</div><div class="l">Patients suivis</div></div>\n        <div class="ti"><div class="n">7</div><div class="l">Spécialités</div></div>\n        <div class="ti"><div class="n">4.8/5</div><div class="l">Satisfaction</div></div>\n      </div>\n    </div>\n\n    <div class="mock-wrap">\n      <div class="b-float f1"><span class="b-dot pulse"></span>Téléconsultation en direct</div>\n      <div class="b-float f2"><span class="b-dot"></span>9 rendez-vous aujourd\'hui</div>\n      <div class="b-mock">\n        <div class="b-mock-top"><span></span><span></span><span></span></div>\n        <div class="b-mock-body">\n          <div class="b-mrow">\n            <div class="b-stat c1"><div class="v">9</div><div class="l">Rendez-vous</div></div>\n            <div class="b-stat c2"><div class="v">3</div><div class="l">En attente</div></div>\n            <div class="b-stat c3"><div class="v">2</div><div class="l">Téléconsult.</div></div>\n          </div>\n          <div class="b-listrow"><div class="b-av">IS</div><div class="who">Ibrahima Sow<span>Consultation générale · 09:30</span></div><span class="b-tag">Confirmé</span></div>\n          <div class="b-listrow"><div class="b-av">AD</div><div class="who">Aminata Diallo<span>Suivi grossesse · 10:15</span></div><span class="b-tag">Confirmé</span></div>\n          <div class="b-listrow"><div class="b-av">MF</div><div class="who">Moussa Faye<span>Téléconsultation · 11:00</span></div><span class="b-tag">Confirmé</span></div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!-- FONCTIONNALITÉS -->\n<div id="fonctionnalites" class="section wrap">\n  <div class="section-hdr">\n    <span class="a-eyebrow">Fonctionnalités</span>\n    <h2>Tout votre centre, dans un seul outil</h2>\n    <p>Une prise en charge complète, du premier rendez-vous au suivi à long terme.</p>\n  </div>\n  <div class="bento">\n    <div class="card big"><div class="ic" style="background:var(--canopy);"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 2v4M16 2v4M3 10h18"/></svg></div><h4>Rendez-vous</h4><p>Planification par jour, filtres par statut, rappels automatiques par SMS.</p></div>\n    <div class="card"><div class="ic" style="background:var(--clay);"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 3.6-6 8-6s8 2 8 6"/></svg></div><h4>Dossiers patients</h4><p>Historique complet et constantes en un coup d\'œil.</p></div>\n    <div class="card"><div class="ic" style="background:var(--gold);"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M10 3h4M12 3v6M6 21h12l-1.5-9h-9L6 21z"/></svg></div><h4>Pharmacie</h4><p>Suivi de stock en temps réel avec alertes de rupture.</p></div>\n    <div class="card big"><div class="ic" style="background:#6D5BB3;"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M15 10l4.55-2.7A1 1 0 0121 8.15v7.7a1 1 0 01-1.45.85L15 14M4 6h9a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z"/></svg></div><h4>Téléconsultation</h4><p>Vidéo, messagerie et prescription, sans changer d\'outil.</p></div>\n  </div>\n</div>\n\n<!-- VALEURS -->\n<div id="valeurs" class="section wrap">\n  <div class="section-hdr">\n    <span class="a-eyebrow" style="background:var(--gold-tint);color:#8a6415;">Nos valeurs</span>\n    <h2>Un centre qui connaît votre famille</h2>\n  </div>\n  <div class="values">\n    <div class="val"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.8 4.6c-1.8-1.8-4.8-1.8-6.6 0L12 6.8l-2.2-2.2c-1.8-1.8-4.8-1.8-6.6 0-1.8 1.8-1.8 4.8 0 6.6L12 20l8.8-8.8c1.8-1.8 1.8-4.8 0-6.6z"/></svg></div><h4>Humanité</h4><p>Chaque patient est écouté, pas juste soigné.</p></div>\n    <div class="val"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4M12 3a9 9 0 100 18 9 9 0 000-18z"/></svg></div><h4>Rigueur</h4><p>Des protocoles suivis avec sérieux, à chaque étape.</p></div>\n    <div class="val"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M9 20v-1a4 4 0 014-4h0a4 4 0 014 4v1M13 7a4 4 0 11-8 0 4 4 0 018 0zM19 7a4 4 0 11-4-4"/></svg></div><h4>Proximité</h4><p>Un centre de quartier, pensé pour Thiès.</p></div>\n  </div>\n</div>\n\n<!-- CHIFFRES -->\n<div class="section wrap">\n  <div class="stats">\n    <div><div class="n" data-count="12000">0</div><div class="l">Patients suivis</div></div>\n    <div><div class="n" data-count="7">0</div><div class="l">Rôles gérés</div></div>\n    <div><div class="n" data-count="98">0</div><div class="l">% de satisfaction</div></div>\n    <div><div class="n" data-count="24">0</div><div class="l">Support 24h/24</div></div>\n  </div>\n</div>\n\n<!-- TÉMOIGNAGES -->\n<div id="temoignages" class="section wrap">\n  <div class="carousel">\n    <div class="slide active"><p>« Le personnel prend vraiment le temps de nous expliquer. On se sent en confiance. »</p><div class="who">Aminata D., patiente depuis 2023</div></div>\n    <div class="slide"><p>« Depuis le nouveau système, la prise de rendez-vous est bien plus simple pour tout le monde. »</p><div class="who">Dr. Ndiaye, médecin au Tropical</div></div>\n    <div class="slide"><p>« La téléconsultation m\'a évité un déplacement alors que j\'étais loin de Thiès. »</p><div class="who">Khady B., patiente</div></div>\n    <div class="dots"><button class="active" data-i="0"></button><button data-i="1"></button><button data-i="2"></button></div>\n  </div>\n</div>\n\n<!-- CTA -->\n<div class="wrap">\n  <div class="final-cta">\n    <h2>Prêt à prendre rendez-vous ?</h2>\n    <p>Notre équipe vous accueille du lundi au samedi.</p>\n    <button class="btn btn-ghost" onclick="location.href=\'/login\'">Se connecter à mon espace</button>\n  </div>\n</div>\n\n<footer class="foot">\n  <div class="wrap">\n    <div class="col"><h4>LE TROPICAL</h4><div>Centre de santé<br>Thiès, Sénégal</div></div>\n    <div class="col"><h4>Contact</h4><div>+221 XX XXX XX XX<br>contact@letropical.sn</div></div>\n    <div class="col"><h4>Horaires</h4><div>Lun–Sam · 08h–18h<br>Urgences 24h/24</div></div>\n  </div>\n  <div class="bottom wrap">© 2026 LE TROPICAL — SGRDMS</div>\n</footer>\n\n<script>\n/* animated counters, triggered once when in view */\nconst counters=document.querySelectorAll(\'.n[data-count]\');\nlet done=false;\nfunction runCounters(){\n  if(done) return; done=true;\n  counters.forEach(el=>{\n    const target=+el.dataset.count;\n    let cur=0; const step=Math.max(1,Math.round(target/40));\n    const t=setInterval(()=>{cur+=step; if(cur>=target){cur=target;clearInterval(t);} el.textContent=cur.toLocaleString(\'fr-FR\');},30);\n  });\n}\nconst obs=new IntersectionObserver(entries=>{entries.forEach(e=>{if(e.isIntersecting) runCounters();});},{threshold:.4});\ndocument.querySelectorAll(\'.stats\').forEach(s=>obs.observe(s));\n\n/* testimonial carousel autoplay */\nlet ci=0;\nconst slides=document.querySelectorAll(\'.slide\');\nconst dots=document.querySelectorAll(\'.dots button\');\nfunction showSlide(i){\n  slides.forEach(s=>s.classList.remove(\'active\'));\n  dots.forEach(d=>d.classList.remove(\'active\'));\n  slides[i].classList.add(\'active\'); dots[i].classList.add(\'active\'); ci=i;\n}\ndots.forEach(d=>d.addEventListener(\'click\',()=>showSlide(+d.dataset.i)));\nsetInterval(()=>showSlide((ci+1)%slides.length),4500);\n</script>\n</body>\n</html>\n'
